...
export default {
  ...
  scrollPageUp() {
    ...
    editor.scrollAnimation(0, offset, parseInt(offset/100*this.pageFactor, 10), true)
  },
  ...
  scrollUpByCountOfLines() {
    ...
    editor.scrollAnimation(0, offset, parseInt(offset/100*this.lineFactor, 10), true)
  },
  ...
  scrollLeftByCountOfLines() {
    let editor = atom.workspace.getActiveTextEditor()
    let offset = -editor.lineHeightInPixels*this.lineCount
    editor.scrollAnimation(offset, 0, parseInt(offset/100*this.lineFactor, 10), true)
  },
